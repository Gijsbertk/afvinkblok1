...
def main():
    ...
    print('Het aantaal CTGAG is', CT) #print hoeveel keer het eiwit voorkomt
    TC = sequentie.count("TCCGGA") #telt het eiwit
    print('Het aantaal TCCGGA is', TC) #print hoeveel keer het eiwit voorkomt
    GA = sequentie.count("GAATTC") #telt het eiwit
    print('Het aantal GAATTC is', GA) #print hoeveel keer het eiwit voorkomt
    AA = sequentie.count("AAGCTT") #telt het eiwit
    print('Het aantal AAGCTT is', AA) #print hoeveel keer het eiwit voorkomt
    TCG = sequentie.count("TCGA") #telt het eiwit
    print('Het aantal TCGA is', TCG) #print hoeveel keer het eiwit voorkomt
